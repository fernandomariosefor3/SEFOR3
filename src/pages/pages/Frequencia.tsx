      ...
      <div className="bg-white rounded-2xl p-6 shadow border-b-4 border-[#ca8a04]">
        ...
        {turma ? (
          <div>
            ...
            <button className="mt-6 w-full bg-[#15803d] text-white font-black py-4 rounded-xl hover:bg-[#166534] transition-all text-lg">
              SALVAR FREQUÊNCIA
            </button>
          </div>
        ) : (
          <div className="text-center py-16 text-gray-400 font-bold border-4 border-dashed rounded-2xl">
            Selecione a escola e a turma para iniciar a chamada
          </div>
        )}
      </div>
    </div>
